...
Proves the thing `payload_sim` exists for -- that `mongla.fire()`, and with it
...
than a log line.
    ...
    ros2 launch mongla_sim_bringup sim.launch.py course:=robosub26_full \
...
PORT = f'/tmp/mongla-{os.environ.get("USER", "user")}/payload'
