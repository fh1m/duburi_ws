...
# Matches <arrangement> tilt in mongla_sim_description/models/mongla_heavy/model.sdf.in
_BEAM_TILT_DEG = 30.0


class DvlBridge(Node):
    def __init__(self):
        super().__init__('mongla_sim_dvl_bridge')
        ...
        # mongla_sim_description/models/mongla_heavy/model.sdf.in. Parameters
