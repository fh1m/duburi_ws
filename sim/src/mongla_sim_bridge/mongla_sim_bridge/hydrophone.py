...
Publishes:
  <ns>/bearing   mongla_interfaces/... -- no custom msg; see below
...
only diagnostic surface, and adding to mongla_interfaces would put a sim concept
...
class Hydrophone(Node):
    def __init__(self) -> None:
        ...
        self._pub_ping = self.create_publisher(
            Vector3Stamped, '/mongla/sim/hydrophone/ping', 10)
        self._pub_range = self.create_publisher(
            Range, '/mongla/sim/hydrophone/range', 10)
