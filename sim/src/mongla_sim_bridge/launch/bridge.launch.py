"""Bridge Gazebo topics into the /mongla/sim namespace that mongla_ws expects.
...
FRONT_IMAGE = '/mongla/sim/front_camera/image_raw'
BOTTOM_IMAGE = '/mongla/sim/bottom_camera/image_raw'
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        #
        # Observability only. The control path (mongla_sensors' SimDvlSource)
