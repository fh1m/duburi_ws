...
from mongla_sim_bridge.fault_injection import (
    CAMERA_PROCESSES,
    DVL_OUT,
    DVL_RAW,
    FaultInjection,
...
from mongla_sim_bridge.t200_curve import T200Curve
...
def test_dvl_interposition_names_do_not_collide():
    ...
    assert DVL_OUT == '/dvl/velocity', (
        'SimDvlSource in mongla_sensors reads this exact topic')
...
def test_the_vehicle_model_publishes_the_raw_dvl_topic():
    ...
    quietly pass.
    """
    sdf = os.path.join(HERE, '..', '..', 'mongla_sim_description', 'models',
                       'mongla_heavy', 'model.sdf')
