...
The full chain (board -> PTY -> real BNO085Source -> /mongla/state vs Gazebo
...
from mongla_sim_bridge.bno085_sim import (
...
FIRMWARE_DOC = os.path.join(
    HERE, '..', '..', '..', '..', 'src', 'mongla_sensors', 'firmware',
    'esp32c3_bno085.md')
...
def test_stream_rate_matches_the_firmware_contract():
    ...
    from mongla_sensors.sources.bno085 import _STALE_S
...
def test_the_board_emits_sensor_frame_ccw():
    ...
    from mongla_sim_bridge import bno085_sim
