...
"""Reach mongla_sim_worlds' prop library from this package.

The prop emitters live in mongla_sim_worlds, which is an ament_cmake package, so
...
def load_prop_library():
    """Import mongla_sim_worlds' prop_library, or return None if unavailable."""
