...
a course is a one-liner.
    ...
    ros2 run mongla_sim_scenarios props add sauvc_drum_red drum_x 8.0 -1.6
    ros2 run mongla_sim_scenarios props move drum_x 9.0 -2.0 --yaw 0.5
...
class PropClient(Node):
    ...
    def __init__(self):
        super().__init__('mongla_sim_props_cli')
    ...
    def wait(self, client) -> bool:
        ...
        print(
            ...
            '  ros2 run mongla_sim_scenarios prop_manager '
...
def cmd_list(_node, library, _args) -> int:
    ...
    if not names:
        print('no prop library available; is mongla_sim_worlds installed?')
        return 1
