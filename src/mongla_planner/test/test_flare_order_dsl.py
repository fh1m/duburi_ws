"""`mongla.flare_order()`: this mission's order, or None -- never a practice run's."""
import json
import time
...
def _run(latched_offset_s=None, rx_age_s=0.0):
    ...
    try:
        ...
        MonglaMission.flare_order(m)                                   # subscribe
        ...
        return MonglaMission.flare_order(m, timeout=0.05)
    finally:
        node.destroy_node()
