...
Sim / webcam testing (yolov11n pretrained):
  ...
  ros2 run mongla_planner mission move_and_see
...
def run(mongla, log):
    ...
    mongla.move_forward(3.0, gain=SCOUT_GAIN)
