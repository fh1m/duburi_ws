...
duburi_control/commands.py exactly so nothing changes if the operator never
...
from duburi_manager.vision_tunables import (            # noqa: E402
    VISION_PARAM_DEFAULTS, _FIELDS_PER_COMMAND, runtime_defaults_for_command)
from duburi_control.commands import COMMANDS, fields_for  # noqa: E402
...
def test_the_tracker_outlives_the_coast():
    ...
    """
    import re, os
    y = os.path.join(_WS, 'src/duburi_vision/config/tracker.yaml')
