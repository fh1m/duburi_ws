...
from duburi_control.motion_vision import _derotated_ex, DEROTATE_MAX_AGE_S
...
from duburi_control.vision_verbs import _derotation_inputs       # noqa: E402
...
def test_the_verb_passes_derotation_into_the_loop():
    src = (Path(__file__).resolve().parents[1] / 'duburi_control'
