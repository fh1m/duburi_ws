...
from duburi_control.fc.base import (FIRE_FIRED, FIRE_REJECTED_ARM, FIRE_DISABLED,
                                    ...
                                    FIRE_BUSY)
from duburi_planner.state_machines.core.outcomes import SUCCEED, FAILED
from duburi_planner.state_machines.states.utility import FireState


class _Result:
    """Stands in for the Move.Result a `duburi.fire()` goal returns."""
...
def test_plans_with_a_firestate_still_build(name, params):
    from duburi_planner.state_machines.plans.torpedo_fire import build_torpedo_fire_fsm
    from duburi_planner.state_machines.plans.bin_drop import build_bin_drop_fsm
    from duburi_planner.state_machines.plans.full_competition import (
