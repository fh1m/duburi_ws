...
from duburi_control.vision_verbs import _fired_suffix
from duburi_planner.duburi_dsl import DuburiMission
from duburi_planner.vision_dsl import VisionResult, _VisionDSL, ALIGNED
...
def _vision(message, x=12.0):
    ...
    dsl._record_vision = lambda *a: DuburiMission._record_vision(dsl, *a)
...
def test_an_evidence_frame_is_written_as_a_viewable_ppm(tmp_path):
    from duburi_planner.duburi_dsl import _write_ppm
