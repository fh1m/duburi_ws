...
from duburi_interfaces.msg import TargetCorrespondences, TargetPose


class PnPNode(Node):
    def __init__(self, **kw):
        super().__init__('duburi_pnp', **kw)
        ...
        from duburi_vision.anchor.pose import AMBIGUITY_MAX, MAX_REPROJ_PX
    ...
    def _on_corr(self, msg):
        from duburi_vision.anchor.pose import solve_pnp
