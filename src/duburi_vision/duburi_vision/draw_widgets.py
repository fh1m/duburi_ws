...
from ._text_engine import pil_text, pil_text_size, _pil_font  # noqa: F401 -- used by widgets + pre-warm
...
# Pre-warm TrueType font cache at module import so the first dashboard frame
# renders without a synchronous disk read for each pixel size.
for _px in (8, 9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 28, 30):
    _pil_font(_px)
