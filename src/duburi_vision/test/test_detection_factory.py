...
from duburi_vision.detection.factory import (      # noqa: E402
...
def test_the_resolver_walks_the_same_extension_order():
    ...
    src = (Path(__file__).resolve().parents[1]
           / 'duburi_vision' / 'detection' / 'yolo.py').read_text()
...
def test_an_explicit_hef_path_is_passed_through():
    ...
    from duburi_vision.detection.yolo import _resolve_model_path
...
# --------------------------------------------------------------------------- #
from duburi_vision.detection.hailo import letterbox   # noqa: E402
