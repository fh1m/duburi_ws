...
# _PKG is src/duburi_vision, so parents[1] is the WORKSPACE ROOT and the sim
...
_SIM_SPEC = _PKG.parents[1] / 'sim' / 'src' / 'duburi_sim_worlds' / 'spec'
...
def test_lock_node_ACTUALLY_consults_the_table():
    ...
    src = (_PKG / 'duburi_vision' / 'lock_node.py').read_text()
