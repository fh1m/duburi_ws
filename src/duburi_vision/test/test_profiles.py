...
from duburi_vision.detection.profiles import (      # noqa: E402
...
def test_unset_is_a_SENTINEL_not_a_comparison_to_the_default():
    ...
    """
    from duburi_vision.detector_node import _UNSET, _is_unset
...
def test_conf_is_deliberately_NOT_profile_routed():
    ...
    src = (Path(__file__).resolve().parents[1] / 'duburi_vision'
           / 'detector_node.py').read_text()
    from duburi_vision.detector_node import _UNSET
