...
from duburi_vision.detection.contours import (
...
from duburi_vision.detector_node import _split_active
...
class TestContourMessage:
    def test_every_detection_gets_exactly_one_contour(self):
        ...
        from duburi_vision.detection.messages import detections_to_contours
...
class TestMergedClassIds:
    ...
    def test_two_models_zeroth_classes_stop_colliding(self):
        from duburi_vision.detection.messages import remint_class_ids
        merged = [
    ...
    def test_the_id_agrees_with_what_the_wire_mints(self):
        ...
        from duburi_vision.detection.messages import class_index, remint_class_ids
