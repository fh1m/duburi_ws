"""``ros2 run mongla_localization course_survey`` -- write MEASURED prop positions.
...
(`$MONGLA_COURSE_DIR` or `~/.mongla/courses/<course>.yaml`), never the package.
...
from mongla_localization import course_map as cm
