...
from mongla_vision.continuity import (           # noqa: E402
...
def test_every_ladder_rung_is_a_real_constant():
    ...
    mongla_control.motion_vision import VISION_FRESH_ZERO_S`, and in a git
    ...
    fresh_zero = _const('mongla_control/mongla_control/motion_vision.py',
                        'VISION_FRESH_ZERO_S')
