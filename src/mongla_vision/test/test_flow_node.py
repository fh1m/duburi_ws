...
from mongla_vision.flow.flow_node import (             # noqa: E402
...
class TestGyroGainDefault:
    ...
    def test_the_lens_pivot_gains_are_kept_so_nobody_re_derives_them(self):
        ...
        from mongla_vision.flow.flow_node import _GYRO_GAIN_LENS_PIVOT
...
class TestQualityConvention:
    ...
    def test_a_real_but_poor_fix_never_reports_zero(self):
        ...
        from mongla_vision.flow.flow_velocity import FlowVelocity
        n = _make(pool_depth_m=4.0)
        try:
...
_CAL = ('src/mongla_vision/config/calibration/pi_downward_1280x720.json')
...
class TestSunCausticsReachTheNode:
    ...
    def test_a_caustic_anchor_and_its_partner_are_both_eroded(self):
        from mongla_vision.flow.flow_math import suppress_caustics
...
class TestSunOnABareFloorRefuses:
    ...
    def _run(self, ncc, sun=True):
        ...
        try:
            ...
            n._frame_i = 5
            with mock.patch('mongla_vision.flow.flow_node.patch_ncc_median',
                            return_value=ncc):
...
class TestFloorHeightIsPublished:
    ...
    def _read(self, grating):
        ...
        try:
            ...
            with mock.patch('mongla_localization.tile_grating.measure',
