...
from mongla_vision.flow.flow_velocity import (          # noqa: E402
...
def test_flow_dispersion_is_small_for_a_COHERENT_translation():
    import numpy as np
    from mongla_vision.flow.flow_math import flow_dispersion
...
def test_the_coherence_gate_PASSES_realistic_motion():
    ...
    when this was 0.5."""
    from mongla_vision.flow.flow_velocity import MAX_DISPERSION_RATIO
