...
mechanism is not another comment: it is `mongla_vision.qos`, one table both
...
from mongla_vision import qos                                    # noqa: E402
...
def test_no_file_hand_rolls_a_qos_for_a_guarded_topic():
    ...
    assert not offenders, (
        'these construct their own QoS for a topic mongla_vision.qos owns; '
...
def test_the_control_host_does_not_subscribe_to_raw_images():
    ...
    vs = SRC / 'mongla_manager' / 'mongla_manager' / 'vision_state.py'
