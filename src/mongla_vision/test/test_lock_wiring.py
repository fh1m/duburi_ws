...
VS = (ROOT / 'mongla_manager' / 'mongla_manager' / 'vision_state.py').read_text()
MV = (ROOT / 'mongla_control' / 'mongla_control' / 'motion_vision.py').read_text()
TUN = (ROOT / 'mongla_manager' / 'mongla_manager'
