...
Topics:
  ...
  out   /mongla/vision/<cam>/vis_range       std_msgs/Float32MultiArray  (one float per detection, 0=far 1=close)
  out   /mongla/vision/<cam>/vis_range_map   sensor_msgs/Image  (float32 depth map, debug only)
"""
...
from mongla_vision.detection.messages import _msg_bbox_center
...
class DepthEstimationNode(Node):
    def __init__(self):
        super().__init__('mongla_depth_estimator')
