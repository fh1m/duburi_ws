...
def test_generated_command_reference_matches_the_code():
    """.claude/context/reference/commands.md is generated by tools/gen_reference.py
    from commands.py, srot_fc.py, srot_protocol.py, the setup.py entry points,
    the launch files and every declare_parameter call. A hand-written reference
    table drifts the day someone edits the code beside it; this one cannot,
    because this test regenerates it and compares."""
    import subprocess
    import sys
