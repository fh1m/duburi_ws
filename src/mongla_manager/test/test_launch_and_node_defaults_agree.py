...
`auv_manager_node.declare_parameter` is what a bare `ros2 run mongla_manager
...
_NODE   = os.path.join(_PKG, 'mongla_manager', 'auv_manager_node.py')
...
def _node_defaults():
    ...
    import importlib
    cc = importlib.import_module('mongla_manager.connection_config')
    out = {}
