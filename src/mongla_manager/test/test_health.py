...
from mongla_manager.health import (                     # noqa: E402
    Health, HealthBoard, State, degraded, failed, ok, unknown)
from mongla_manager import health_reporters as R        # noqa: E402
...
def _manager_stub(fc=None, det_hz=None):
    ...
    """
    from mongla_manager.auv_manager_node import AUVManagerNode as N
    m = SimpleNamespace()
...
def _registered_names():
    ...
    src = (Path(__file__).resolve().parents[1]
           / 'mongla_manager' / 'auv_manager_node.py').read_text()
    names = set()
...
def test_every_defined_reporter_is_registered_or_explained():
    ...
    """
    import inspect
    from mongla_manager import health_reporters as _R
