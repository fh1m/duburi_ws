# mongla_interfaces — the whole cross-package surface

**Messages only · [`src/mongla_interfaces`](../../../../src/mongla_interfaces)**
...
## `MonglaState.msg` — what the vehicle is doing
...
Related: [`mongla_manager`](../mongla_manager/README.md) (serves the action) ·
[`mongla_planner`](../mongla_planner/README.md) (sends the goals)
