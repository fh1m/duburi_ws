...
# the tests (5 suites, 3 549 of them, ~5 minutes)
...
flowchart LR
    ...
    HOOK --> UNIT["5 suites · 3 549 tests"]
...
`detected-paradigm` · `precision-alignment` · `vision-results`
